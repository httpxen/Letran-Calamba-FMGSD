  ...
  <div class="flex h-screen overflow-hidden">
    ...
    <div class="flex-1 flex flex-col">
      ...
      <header class="bg-white shadow-sm flex justify-between items-center px-6 py-4">
        ...
        <div class="flex items-center space-x-4">
          <div class="relative">
            <input type="text" id="video-search" placeholder="Search videos by title or description..." oninput="filterVideos()" class="pl-10 pr-4 py-2 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-primary-600">
      ...
      <main class="flex-1 p-6 overflow-y-auto">
        <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between">
          ...
          <div class="flex flex-col sm:flex-row gap-4 mt-4 sm:mt-0">
            <div class="flex items-center gap-2">
              ...
              <select id="category-filter" onchange="filterVideos()" class="px-3 py-2 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-primary-600">
            ...
            <div class="flex items-center gap-2">
              ...
              <input type="date" id="date-filter" onchange="filterVideos()" class="px-3 py-2 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-primary-600">
            </div>
          </div>
        </div>
        ...
        <?php else: ?>
          <div class="no-videos text-center py-10">
  ...
  <script>
    ...
    function filterVideos() {
      ...
      if (visibleCards.length === 0 && !noVideosMessage) {
        ...
        message.className = 'no-videos text-center py-10';
