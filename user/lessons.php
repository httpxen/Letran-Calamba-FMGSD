  ...
  <div class="flex h-screen overflow-hidden">
    ...
    <div class="flex-1 flex flex-col">
      ...
      <main class="flex-1 p-6 overflow-y-auto">
        ...
        <div id="completed-message" class="hidden fixed top-4 right-4 bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded-lg shadow-md z-50 transition-opacity duration-300">
        ...
        <?php if ($rowCount > 0): ?>
          <div class="space-y-4">
            <?php foreach ($lessons as $index => $lesson): ?>
              ...
              <?php elseif ($isFailed): ?>
                <a href="lesson.php?lesson_id=<?= $lesson['id'] ?>" class="failed-lesson-card bg-white rounded-lg shadow-md p-4 flex justify-between items-center hover:shadow-lg transition-shadow duration-200">
                  <div class="flex items-center gap-3">
              ...
              <?php elseif ($isLocked): ?>
                <div class="locked-lesson-card bg-gray-100 rounded-lg shadow-md p-4 flex justify-between items-center cursor-not-allowed opacity-60">
                  <div class="flex items-center gap-3">
