      ...
      <div class="flex-1 flex flex-col">
        ...
        <main class="flex-1 p-6 overflow-y-auto">
          <div class="bg-white rounded-lg shadow-md p-6 max-w-lg mx-auto">
            <h2 class="text-2xl font-semibold text-dashboard mb-6">Add New Admin</h2>
            <form id="add-admin-form" action="process_add_admin.php" method="POST">
              <div class="mb-5">
                <label
                  for="fullname"
                ...
                <input
                  ...
                  id="fullname"
                  name="fullname"
                  class="block w-full rounded-md border border-gray-300 px-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary-600 transition-all duration-200"
                  required
                />
              </div>
              <div class="mb-5">
              ...
              <div class="flex justify-end space-x-3">
                <a
                  href="dashboard.php"
                  class="px-4 py-2 bg-gray-200 text-gray-700 rounded-md hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-400 transition-all duration-200"
                >
                  Cancel
                </a>
                <button
                  type="submit"
                  class="px-4 py-2 bg-primary-600 text-white rounded-md hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-primary-600 transition-all duration-200"
                >
                  Add Admin
                </button>
              </div>
